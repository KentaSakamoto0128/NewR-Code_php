    ...
    <button id="langchange"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="40" height="40">
        ...
        <label class="selectbox-detail">
            <select name="language" onchange="location.href=value;">
                ...
                <option value="home-en.php" selected>English</option>
                <option value="home-cnt.php">繁體中文</option>
                <option value="home-cn.php">简体中文</option>
            </select>
        </label>
    </button>
    <button id="usericon" class="guest" onclick="location.href='login_from.php'"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="40" height="40">
...
<div id="edit">
    <ul>
        <li>
            <a href="canvas.html"><button title="New File"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="72" height="72">
                        <path d="M11 11V5H13V11H19V13H13V19H11V13H5V11H11Z"></path>
                    </svg></button></a>
        </li>
        <li>
            <button title="Edit"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="72" height="72">
        ...
        <li>
            <button title="Upload"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="72" height="72">
        ...
        <li><button title="Information"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="72" height="72">
...
<p id="small"><small>QR Code &reg; is a registered trademark of DENSO WAVE INCORPORATED.</small></p>
