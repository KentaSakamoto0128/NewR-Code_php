    ...
    <button id="langchange"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="40" height="40">
        ...
        <label class="selectbox-detail">
            <select name="language" onchange="location.href=value" ;>
                ...
                <option value="home-cn.php" selected>简体中文</option>
            </select>
        </label>
    </button>
    <button id="usericon" class="guest" onclick="location.href='login_form.php'"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="40" height="40">
...
<div id="edit">
    <ul>
        <li>
            <a href="canvas.html"><button title="创建新的"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="72" height="72">
                        <path d="M11 11V5H13V11H19V13H13V19H11V13H5V11H11Z"></path>
                    </svg></button></a>
        </li>
        <li>
            <button title="编辑"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="72" height="72">
        ...
        <li>
            <button title="上传"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="72" height="72">
        ...
        <li><button title="信息"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="72" height="72">
...
<p id="small"><small>QR Code&reg; 是 DENSO WAVE CORPORATION 的注册商标</small></p>
