...
<div id="edit">
    <ul>
        <li>
            <a href="canvas.html"><button title="創建新的"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="72" height="72">
                        <path d="M11 11V5H13V11H19V13H13V19H11V13H5V11H11Z"></path>
                    </svg></button></a>
        </li>
        <li>
            <button title="編輯"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="72" height="72">
